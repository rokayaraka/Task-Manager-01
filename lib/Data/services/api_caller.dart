    ...
    static Future<ApiResponse>getRequest({required String URL}) async {
        try{
            ...
            if(response.statusCode == 200){
                return ApiResponse(responseCode: 200, responseData: jsonDecode(response.body), isSuccess: true, errorMessage: '');
            }else{
                return ApiResponse(responseCode: response.statusCode, responseData: jsonDecode(response.body), isSuccess: false, errorMessage: '');
